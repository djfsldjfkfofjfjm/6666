  ...
  return (
    <div className="p-8 bg-gradient-to-br from-gray-50 to-gray-100 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-2">Анализ воронки ВКонтакте</h2>
          ...
          <div className="col-span-8">
            <Card className="p-8 bg-white">
              <div className="space-y-8">
                {/* Этап 1: Все заявки */}
                <div className="flex justify-between items-center p-4 bg-gradient-to-r from-blue-50 to-white rounded-lg">
                ...
                <div className="flex justify-between items-center p-4 bg-gradient-to-r from-blue-50 to-white rounded-lg">
                  ...
                  <div className="text-xl font-bold text-blue-600">26.24%</div>
                </div>
                ...
                <div className="flex justify-between items-center p-4 bg-gradient-to-r from-blue-50 to-white rounded-lg">
                  ...
                  <div className="text-xl font-bold text-blue-600">7.29%</div>
                </div>
                ...
                <div className="flex justify-between items-center p-4 bg-gradient-to-r from-blue-50 to-white rounded-lg">
                  ...
                  <div className="text-xl font-bold text-blue-600">40.00%</div>
                </div>

                {/* Конверсия из заявки в продажу */}
                <div className="flex justify-between items-center p-4 bg-gradient-to-r from-blue-50 to-white rounded-lg border-2 border-blue-200">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <div className="text-2xl font-bold">7.29%</div>
                    </div>
                  </div>
            ...
            <Card className="p-6 bg-gradient-to-br from-blue-500 to-blue-700 text-white">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span>Выручка</span>
                  <span className="font-bold">{formatMoney(3894477)}</span>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold">{formatMoney(3894477/25)}</span>
                </div>
              </div>
            </Card>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-sm text-gray-500">10.79%</div>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">% выручки повторных</span>
                  <div className="text-right">
                    <div className="font-bold">45.47%</div>
                    <div className="text-sm text-gray-500">{formatMoney(1770688)}</div>
                  </div>
                </div>
              </div>
            </Card>
